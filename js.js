...
function createMarker(obj) {
    ...
    $.ajax({
        ...
        method: "GET"
          ...
          //console.log("Length of array: " + response.result.photos.length);
          //console.log(response.result.name);
          //ref = response.result.photos[1].photo_reference;
          //console.log("This is the photo reference of one photo: " + ref);
          console.log(response);
          //console.log(response.result.photos[0].photo_reference);
                  //console.log(response.result.photos[3].photo_reference);
        ...
        ref = response.result.photos[0].photo_reference;
          ...
          //{
              //console.log("Photo Ref: "+ i + " " +response.result.photos[i].photo_reference);
          //    ref.push(response.result.photos[i].photo_reference);
          //}
          //console.log("This gives me the contents of the references array");

          //console.log(response.result.photos[3].photo_reference);
          //console.log(response.result.photos[4].photo_reference);
